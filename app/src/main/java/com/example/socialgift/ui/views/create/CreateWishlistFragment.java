...
public class CreateWishlistFragment extends Fragment {
    ...
    private final SimpleDateFormat sendDateFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", Locale.ENGLISH);
    private Date date;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        Button createWishlistButton = view.findViewById(R.id.create_wishlist_create_button);
    ...
    private void setUpDateEditText() {
        ...
        wishlistDateEditText.setOnClickListener(v -> new DatePickerDialog(getContext(), date, myCalendar
